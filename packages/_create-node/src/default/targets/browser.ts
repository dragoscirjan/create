  ...
  return updatePackageJson(options, (object: PackageJsonOptions) => ({
    ...
    scripts: {
      ...
      "build:browser-bundle-min":
        "esbuild --minify --bundle dist/browser/index.js --format=esm " +
        "--target=es2020 --outfile=dist/browser/index.bundle.min.js",
      "build:browser-umd":
        "rollup dist/browser/index.bundle.js --format umd " +
        '--name "@templ-project/node-typescript" -o dist/browser/index.umd.js',
      "build:browser-umd-min":
        "rollup dist/browser/index.bundle.min.js --compact --format umd " +
        '--name "@templ-project/node-typescript" -o dist/browser/index.umd.min.js',
    },
  }));
}
